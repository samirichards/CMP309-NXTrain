...
public class StationSearchActivity_ViewModel extends AndroidViewModel implements Observable {
    ...
    public StationSearchActivity_ViewModel(@NonNull Application application) {
        super(application);
